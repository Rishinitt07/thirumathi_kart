...
function useCounter(initialValue, max, min) {
  ...
  var init2 = resolveHookState(initialValue);
  typeof init2 !== "number" && console.error("initialValue has to be a number, got " + typeof initialValue);
  ...
  var _a = useGetSet(init2), get = _a[0], setInternal = _a[1];
  return [
    get(),
