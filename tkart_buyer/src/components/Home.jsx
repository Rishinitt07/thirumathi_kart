...
import { FiSearch, FiShoppingCart, FiUser, FiChevronRight, FiStar, FiClock, FiTruck } from 'react-icons/fi';
import { BsStarFill, BsLightningFill, BsGem, BsFlower1, BsBasket, BsShop, BsDroplet } from 'react-icons/bs';
import { GiClothes, GiFruitBowl, GiHealthNormal, GiOfficeChair } from 'react-icons/gi';
      ...
      <main className="container mx-auto px-4 py-6">
        ...
        <div className="relative rounded-2xl overflow-hidden mb-8 h-64 md:h-80 bg-gradient-to-r from-pink-400 to-rose-400 flex items-center">
          ...
          <div className="relative z-10 px-8 text-white max-w-lg">
            <h1 className="text-3xl md:text-4xl font-bold mb-2">Premium Handpicked Products</h1>
            <p className="text-lg mb-4">Discover authentic goods from local artisans and trusted brands</p>
        ...
        {/* Mobile Search (since we removed the header) */}
        <div className="mb-6 md:hidden">
          <div className="relative w-full">
            ...
            />
            <button className="absolute right-3 top-2 text-pink-500">
        ...
        <section className="mb-10">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/categories" className="text-pink-600 flex items-center text-sm">
        ...
        <section className="mb-10">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/trending" className="text-pink-600 flex items-center text-sm">
              View All <FiChevronRight className="ml-1" />
            </Link>
          </div>
