        ...
        {editable ? (
          options.length > 0 ? (
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:outline-none focus:border-hotpink-400 focus:ring-4 focus:ring-hotpink-50 transition-all font-medium text-gray-800"
              placeholder={`Enter ${label}`}
            />
          )
        ) : (
                ...
                >
                  <div className="mb-8 border-b border-gray-100 pb-4 flex justify-between items-end">
                    <div>
                      ...
                      <p className="text-hotpink-600/80 mt-2 font-medium">Manage your shipping details for deliveries.</p>
                    </div>
                    <button onClick={() => openAddressModal()} className="bg-hotpink-500 hover:bg-hotpink-600 text-white px-4 py-2 rounded-xl shadow font-medium">
                      + Add New
                    </button>
                  </div>
                  ...
                  {addresses.length === 0 ? (
                    <div className="text-center py-10 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200">
                      ...
                      <button onClick={() => openAddressModal()} className="bg-white border border-gray-200 text-hotpink-600 px-6 py-2 rounded-xl shadow-sm font-medium hover:bg-gray-50">
                      ...
                      {addresses.map((addr) => (
                        <div key={addr.id} className="border border-gray-200 rounded-2xl p-5 hover:shadow-md transition-shadow relative bg-white">
                          <div className="flex justify-between items-start mb-3">
                            <span className="bg-hotpink-100 text-hotpink-700 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                              {addr.tag}
                            </span>
                          ...
                          <h4 className="font-semibold text-gray-800 text-lg">{addr.fullName}</h4>
                          ...
                          <p className="text-gray-800 font-medium text-sm mt-3 flex items-center gap-2"><AiOutlinePhone /> {addr.mobile}</p>
                        </div>
                      ))}
                    </div>
                  )}
              ...
              {activeMenu === 'preferences' && (
                ...
                >
                  <div className="mb-8 border-b border-gray-100 pb-4">
                    ...
                    <p className="text-hotpink-600/80 mt-2 font-medium">Submit feedback or configure your preferences.</p>
                  </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
              <div className="flex flex-col">
                ...
                <select name="tag" value={addressForm.tag} onChange={handleAddressChange} className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:outline-none focus:border-hotpink-400 focus:ring-4 focus:ring-hotpink-50 transition-all font-medium text-gray-800 cursor-pointer">
              ...
              <div className="flex flex-col">
                ...
                <input type="text" name="fullName" value={addressForm.fullName} onChange={handleAddressChange} className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:outline-none focus:border-hotpink-400 focus:ring-4 focus:ring-hotpink-50 transition-all font-medium text-gray-800" placeholder="Enter full name" />
              </div>
              <div className="flex flex-col">
                <label className="text-sm font-normal text-gray-500 mb-1.5 tracking-wide uppercase">Mobile *</label>
                <input type="text" name="mobile" maxLength={10} value={addressForm.mobile} onChange={handleAddressChange} className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:outline-none focus:border-hotpink-400 focus:ring-4 focus:ring-hotpink-50 transition-all font-medium text-gray-800" placeholder="Enter mobile number" />
              </div>
              <div className="flex flex-col">
                <label className="text-sm font-normal text-gray-500 mb-1.5 tracking-wide uppercase">Pincode *</label>
                <input type="text" name="pincode" maxLength={6} value={addressForm.pincode} onChange={handleAddressChange} className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:outline-none focus:border-hotpink-400 focus:ring-4 focus:ring-hotpink-50 transition-all font-medium text-gray-800" placeholder="Enter pincode" />
              </div>
              <div className="flex flex-col">
                <label className="text-sm font-normal text-gray-500 mb-1.5 tracking-wide uppercase">House No / Building *</label>
                <input type="text" name="houseNo" value={addressForm.houseNo} onChange={handleAddressChange} className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:outline-none focus:border-hotpink-400 focus:ring-4 focus:ring-hotpink-50 transition-all font-medium text-gray-800" placeholder="Enter house no." />
              </div>
              <div className="flex flex-col">
                <label className="text-sm font-normal text-gray-500 mb-1.5 tracking-wide uppercase">Street / Colony *</label>
                <input type="text" name="street" value={addressForm.street} onChange={handleAddressChange} className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:outline-none focus:border-hotpink-400 focus:ring-4 focus:ring-hotpink-50 transition-all font-medium text-gray-800" placeholder="Enter street" />
              </div>
              <div className="flex flex-col">
                <label className="text-sm font-normal text-gray-500 mb-1.5 tracking-wide uppercase">Area *</label>
                <input type="text" name="area" value={addressForm.area} onChange={handleAddressChange} className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:outline-none focus:border-hotpink-400 focus:ring-4 focus:ring-hotpink-50 transition-all font-medium text-gray-800" placeholder="Enter area" />
              </div>
              <div className="flex flex-col">
                <label className="text-sm font-normal text-gray-500 mb-1.5 tracking-wide uppercase">Landmark</label>
                <input type="text" name="landmark" value={addressForm.landmark} onChange={handleAddressChange} className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:outline-none focus:border-hotpink-400 focus:ring-4 focus:ring-hotpink-50 transition-all font-medium text-gray-800" placeholder="Enter landmark (optional)" />
              </div>
              <div className="flex flex-col">
                <label className="text-sm font-normal text-gray-500 mb-1.5 tracking-wide uppercase">City *</label>
                <input type="text" name="city" value={addressForm.city} onChange={handleAddressChange} className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:outline-none focus:border-hotpink-400 focus:ring-4 focus:ring-hotpink-50 transition-all font-medium text-gray-800" placeholder="Enter city" />
              </div>
              <div className="flex flex-col">
                <label className="text-sm font-normal text-gray-500 mb-1.5 tracking-wide uppercase">State *</label>
                <input type="text" name="state" value={addressForm.state} onChange={handleAddressChange} className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:outline-none focus:border-hotpink-400 focus:ring-4 focus:ring-hotpink-50 transition-all font-medium text-gray-800" placeholder="Enter state" />
              </div>
            </div>
            <div className="mt-8 flex justify-end gap-4">
              <button onClick={() => setShowAddressModal(false)} className="px-6 py-3 border border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 font-medium transition-all">Cancel</button>
              <button onClick={submitAddress} className="px-6 py-3 bg-hotpink-500 hover:bg-hotpink-600 text-white rounded-xl shadow-lg shadow-hotpink-500/20 font-medium transition-all flex items-center gap-2">
