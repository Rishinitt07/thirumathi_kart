...
const ProfilePicture = ({ username, onImageChange }) => {
  return (
...
const Profile = () => {
  ...
  const handleChange = (e) => {
    ...
    // 👇 Special: prevent non-digits in mobile field
  ...
  const validate = () => {
    const temp = {
      ...
      mobile: /^[0-9]{10}$/.test(profile.mobile)
        ? ""
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          <main className="w-full bg-white rounded-lg shadow p-6 border border-pink-100">
            ...
            <button
              ...
              disabled={loading}
              className="bg-pink-600 text-white px-5 py-2 rounded hover:bg-pink-700 disabled:opacity-70"
            >
