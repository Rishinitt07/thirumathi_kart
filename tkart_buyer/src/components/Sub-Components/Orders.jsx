...
const OrderCard = React.memo(({ order, expanded, onToggle, onCancel }) => {
  const totalAmount = order.items.reduce((sum, item) => sum + (item.price * item.quantity), 0);
  const grandTotal = totalAmount + (order.shippingCost || 0) + (order.tax || 0);
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded mb-6">
            ...
            <div className="mt-2">
              <Link to="/login" className="text-sm text-red-700 underline hover:text-red-600">
