        ...
        <div className="md:w-1/2 p-10 bg-white flex flex-col justify-center">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full py-3 mt-4 text-lg font-bold rounded-full shadow-lg transition-all duration-300 transform ${
        ...
        <div className="md:w-1/2 p-10 bg-white flex flex-col justify-center">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <div className="flex-1 flex items-center border-2 border-gray-100 rounded-xl px-4 py-3 bg-gray-50 focus-within:border-blue-500 focus-within:bg-white transition-colors">
                <MdOutlinePerson className="text-gray-400 mr-3 text-xl" />
                <input
                  type="text"
                  name="name"
...
with open("tkart_delivery/src/login.jsx", "w") as f:
    f.write(login_content)

with open("tkart_delivery/src/register.jsx", "w") as f:
    f.write(register_content)

os.system("cp tkart_seller/src/tkart.png tkart_delivery/src/")
